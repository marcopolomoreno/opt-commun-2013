...
int pontos,i,j,k,m,n,modos,modosTotal;
...
main() 
{
    ...
    //13/05/2012
    //modificações: 13/09/12 (1) 14-09-12
    ...
    {        
        ...
        fprintf(arquivo,"%d %16.14f %16.14f %16.14f %16.14f %16.14f",
               n,c[1],c[2],sqrt(c[3]*c[3]+c[4]*c[4]),c[3],c[4]);   
        fprintf(arquivo,"\n");
